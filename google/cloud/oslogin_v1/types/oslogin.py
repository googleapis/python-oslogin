...
class LoginProfile(proto.Message):
    ...
    Attributes:
        ...
        posix_accounts (MutableSequence[google.cloud.oslogin.common.types.PosixAccount]):
            The list of POSIX accounts associated with
            the user.
        ssh_public_keys (MutableMapping[str, google.cloud.oslogin.common.types.SshPublicKey]):
...
class CreateSshPublicKeyRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            ``users/{user}``.
        ssh_public_key (google.cloud.oslogin.common.types.SshPublicKey):
