...
@pytest.mark.parametrize("client_class", [
    OsLoginServiceClient, OsLoginServiceAsyncClient
])
@mock.patch.object(OsLoginServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(OsLoginServiceClient))
@mock.patch.object(OsLoginServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(OsLoginServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (OsLoginServiceClient, transports.OsLoginServiceGrpcTransport, "grpc", grpc_helpers),
    (OsLoginServiceAsyncClient, transports.OsLoginServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_create_ssh_public_key(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_ssh_public_key),
            '__call__') as call:
...
def test_create_ssh_public_key_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        return_value = common_pb2.SshPublicKey(
              key='key_value',
              expiration_time_usec=2144,
              fingerprint='fingerprint_value',
              name='name_value',
...
def test_create_ssh_public_key_rest_interceptors(null_interceptor):
    transport = transports.OsLoginServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.OsLoginServiceRestInterceptor(),
        )
    client = OsLoginServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.OsLoginServiceRestInterceptor, "post_create_ssh_public_key") as post, \
         mock.patch.object(transports.OsLoginServiceRestInterceptor, "pre_create_ssh_public_key") as pre:
        ...
        req.return_value._content = json_format.MessageToJson(common_pb2.SshPublicKey())
        ...
        post.return_value = common_pb2.SshPublicKey()
...
def test_delete_posix_account_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.OsLoginServiceRestInterceptor, "pre_delete_posix_account") as pre:
        pre.assert_not_called()
...
def test_delete_ssh_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.OsLoginServiceRestInterceptor, "pre_delete_ssh_public_key") as pre:
        pre.assert_not_called()
...
def test_get_login_profile_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = oslogin.LoginProfile.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_login_profile_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.OsLoginServiceRestInterceptor, "post_get_login_profile") as post, \
         mock.patch.object(transports.OsLoginServiceRestInterceptor, "pre_get_login_profile") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_ssh_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.OsLoginServiceRestInterceptor, "post_get_ssh_public_key") as post, \
         mock.patch.object(transports.OsLoginServiceRestInterceptor, "pre_get_ssh_public_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_import_ssh_public_key_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = oslogin.ImportSshPublicKeyResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_import_ssh_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.OsLoginServiceRestInterceptor, "post_import_ssh_public_key") as post, \
         mock.patch.object(transports.OsLoginServiceRestInterceptor, "pre_import_ssh_public_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_ssh_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.OsLoginServiceRestInterceptor, "post_update_ssh_public_key") as post, \
         mock.patch.object(transports.OsLoginServiceRestInterceptor, "pre_update_ssh_public_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
