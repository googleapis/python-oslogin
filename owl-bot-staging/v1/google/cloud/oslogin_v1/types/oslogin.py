...
class LoginProfile(proto.Message):
    ...
    Attributes:
        ...
        posix_accounts (MutableSequence[google.cloud.oslogin.common.common_pb2.PosixAccount]):
            The list of POSIX accounts associated with
            the user.
        ssh_public_keys (MutableMapping[str, google.cloud.oslogin.common.common_pb2.SshPublicKey]):
    ...
    posix_accounts: MutableSequence[common_pb2.PosixAccount] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
        message=common_pb2.PosixAccount,
    )
    ssh_public_keys: MutableMapping[str, common_pb2.SshPublicKey] = proto.MapField(
        proto.STRING,
        proto.MESSAGE,
        number=3,
        message=common_pb2.SshPublicKey,
    )
...
class CreateSshPublicKeyRequest(proto.Message):
    ...
    ssh_public_key: common_pb2.SshPublicKey = proto.Field(
        proto.MESSAGE,
        number=2,
        message=common_pb2.SshPublicKey,
    )
