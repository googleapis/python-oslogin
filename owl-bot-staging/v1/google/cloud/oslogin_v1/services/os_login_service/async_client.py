    ...
    async def delete_posix_account(self,
        ...
        .. code-block::
            ...
            def sample_delete_posix_account():
                ...
                # Make the request
                response = client.delete_posix_account(request=request)
    ...
    async def delete_ssh_public_key(self,
        ...
        .. code-block::
            ...
            def sample_delete_ssh_public_key():
                ...
                # Make the request
                response = client.delete_ssh_public_key(request=request)
    ...
    async def import_ssh_public_key(self,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            ssh_public_key (:class:`google.cloud.oslogin.common.common_pb2.SshPublicKey`):
